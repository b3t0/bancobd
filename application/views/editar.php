...
<html lang="en">
  ...
  <div class="page-header">
      ...
      <form class="well" action="<?php echo base_url()."principal/actualizar";?>" method="post" accept-charset="utf-8">
        <label>Direccion:</label>
        <input type="text" class="input-block-level" name="direccion" required placeholder="Calle # cra # #casa" 
        value="<?php echo $direccion;?>" autocomplete="off">
        <label>Ciudad:</label>
        <input type="text" class="input-block-level" name="ciudad" required placeholder="Su ciudad" 
        value="<?php echo $ciudad;?>" autocomplete="off">
        <label>Telefono:</label>
        <input type="text" class="input-block-level" name="telefono" required placeholder="Numero telefonico" 
        value="<?php echo $telefono;?>" autocomplete="off">
        
        <a href="#myModal" role="button" class="btn btn-large btn-primary" data-toggle="modal">Actualizar datos</a>
        <!-- Modal -->
        ...
        <button class="btn" data-dismiss="modal" href="<?php echo base_url()."principal/user_info";?>" 
