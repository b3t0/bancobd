...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Consultas de saldo &middot; MyBank</title>
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th>Valor de la ultima transacción</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td><?php echo $ncuenta;?></td>
                  <td><?php echo $user;?></td>
                  <td><?php echo $apellido;?></td>
                  <td><?php echo $saldo_actual;?></td>
                  <td><?php echo $ultima_transaccion;?></td>
                  <td><?php echo $valorut;?></td>
                </tr>
